...
$query_skpp = "SELECT * FROM tb_info  ORDER BY id_info DESC";
...
<?php include('header.php'); ?>
	...
	<section class="banner-area relative" id="home">
     <img class="img-fluid" src="../images/header-bg2.png" alt="">
		<div class="overlay overlay-bg"> <p>&nbsp;</p><br/>
        								<p>&nbsp;</p><br/>
                                        <p>&nbsp;</p>
        									<h1 align="center"><font color="#FFFFFF">Daftar Kuliah Kerja Nyata</font></h1></div>
	</section>
	<!-- End banner Area -->
	...
	<section class="sample-text-area">
	  <div class="container">
			<h3 class="text-heading" align="center">Daftar Mahasiswa</h3>
			<div class="table-responsive">
              <table class="table" id="example">
                    <thead class=" text-dark" align="center">
                   	<th width="10%">No</th>
                        <th width="70%">Nama Info</th>
  ...
  $no = $page  * $maxRows_skpp + 1 ; do { ?>
                      <tr>
                      	<td><?php echo $no; ?></td>
                      <td><?php echo $row_skpp['nama_info']; ?></td>
                      <td class="text-center">
                        <a href="../config/download/download_dokumen_user.php?filename=<?php echo $row_skpp['lampiran'];?>" class=" fa fa-download"> DOWNLOAD</a>
                      </td>
