...
$query_skpp = "SELECT * FROM tb_pengumpulan_laporan  ORDER BY id_pengumpulan DESC";
...
<?php include('header.php'); ?>
	...
	<section class="banner-area relative" id="home">
     <img class="img-fluid" src="../images/header-bg2.png" alt="">
		<div class="overlay overlay-bg"> <p>&nbsp;</p><br/>
        								<p>&nbsp;</p><br/>
                                        <p>&nbsp;</p>
        									<h1 align="center"><font color="#FFFFFF">Laporan Kuliah Kerja Nyata</font></h1></div>
	</section>
	<!-- End banner Area -->
	...
	<section class="sample-text-area">
	  <div class="container">
			<h3 class="text-heading" align="center">Daftar Laporan</h3>
  ...
  $no = $page  * $maxRows_skpp + 1 ; do { ?>
                      <tr>
                    	...
                    	<td class="text-center"><?php 
                          if( $row_skpp['nama_desa'] == "s"){
                            echo "Suput";
                          }else if( $row_skpp['nama_desa'] == "h"){
                            echo "Haruai";
                          }else if( $row_skpp['nama_desa'] == "n"){
                            echo "Nawin";
                          }else if( $row_skpp['nama_desa'] == "sm"){
                            echo "Sungai Miai";
                          }else{
                    ...
                    <td class="text-center"><?php 
                          if( $row_skpp['kecamatan'] == "cls"){
                            echo "Candi Laras Selatan";
                          }else if( $row_skpp['kecamatan'] == "dp"){
                            echo "Danau Panggang";
                          }else if( $row_skpp['kecamatan'] == "p"){
                            echo "Paramasan";
                          }else if( $row_skpp['kecamatan'] == "tt"){
                            echo "Tapin Tengah";
                          }else if( $row_skpp['kecamatan'] == "ts"){
                            echo "Tapin Selatan";
                          }else{
                     ...
                     ?></td>
                      <td class="text-center"><?php 
                          if( $row_skpp['kabupaten'] == "t"){
                            echo "Tapin";
                          }else if( $row_skpp['kabupaten'] == "b"){
                            echo "Banjar";
                          }else if( $row_skpp['kabupaten'] == "hsu"){
