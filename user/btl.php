...
$query_skpp = "SELECT * FROM tb_dokumen WHERE tipe='btl' AND unit='pp' ORDER BY id_dokumen DESC";
...
<?php include('header.php'); ?>
	...
	<section class="banner-area relative" id="home">
     <img class="img-fluid" src="../images/header-bg2.png" alt="">
		<div class="overlay overlay-bg"> <p>&nbsp;</p><br/>
        								<p>&nbsp;</p><br/>
                                        <p>&nbsp;</p>
        									<h1 align="center"><font color="#FFFFFF">Pusat Penelitian & Penerbitan</font></h1></div>
	</section>
	<!-- End banner Area -->
	...
	<section class="sample-text-area">
	  <div class="container">
			<h3 class="text-heading" align="center">Buku Terbitan LP2M</h3>
