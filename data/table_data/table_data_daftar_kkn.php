                    ...
                    <td class="text-center"><?php 
                     ...
                     <td class="text-center">
                                <form method="post" name="form1" id="form1" action="<?php echo $editFormAction; ?>">
                                    <select name="status" class="form-control" id="status" onchange='if(this.value != 0) { this.form.submit(); }'>
                                       <option <?php if($row_daftar_ulang['status'] == 'T') { echo "selected"; }?> value="T" >Terverifikasi</option>
                                        <option <?php if($row_daftar_ulang['status'] == 'TT') { echo "selected"; }?> value="TT" >Tidak Terverifikasi</option>
