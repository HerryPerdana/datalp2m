<div class="col-lg-12">
            <div class="form-panel">
              <form name="pengumpulan_laporan" method="post" action="<?php $editFormAction ?>" class="form-horizontal style-form" enctype="multipart/form-data" id="pengumpulan_laporan">
                  ...
                  <div class="col-md-3 col-xs-11">
                              <input type="email" name="email" placeholder="Email" id="c-name" class="form-control" required="required" maxlength="150" value="<?php echo $row_pengumpulan_laporan['email']; ?>">
                            </div>
                          </div>
                ...
                <select name="kabupaten" class="form-control" id="kabupaten" onchange="tampilkan()">
                  <option <?php if($row_pengumpulan_laporan['kabupaten'] == 't') { echo "selected"; }?> value="t" >Tapin</option>
                  <option <?php if($row_pengumpulan_laporan['kabupaten'] == 'b') { echo "selected"; }?> value="b" >Banjar</option>
                  <option <?php if($row_pengumpulan_laporan['kabupaten'] == 'hsu') { echo "selected"; }?> value="hsu">Hulu Sungai Utara</option>
                </select>
              </div>
            </div>
                ...
                <select name="kecamatan" class="form-control" id="kecamatan">
                    <option <?php if($row_pengumpulan_laporan['kecamatan'] == 'cls') { echo "selected"; }?> value="cls" >Candi Laras Selatan</option>
                  <option <?php if($row_pengumpulan_laporan['kecamatan'] == 'dp') { echo "selected"; }?> value="dp" >Danau Panggang</option>
                  <option <?php if($row_pengumpulan_laporan['kecamatan'] == 'p') { echo "selected"; }?> value="p">Paramasan</option>
                   <option <?php if($row_pengumpulan_laporan['kecamatan'] == 'tt') { echo "selected"; }?> value="tt" >Tapin Tengah</option>
                  <option <?php if($row_pengumpulan_laporan['kecamatan'] == 'ts') { echo "selected"; }?> value="ts">Tapin Selatan</option>
            ...
            <div class="form-group">
                ...
                <select name="nama_desa" class="form-control" id="nama_desa">
                  <option <?php if($row_pengumpulan_laporan['nama_desa'] == 's') { echo "selected"; }?> value="s" >Suput</option>
                  <option <?php if($row_pengumpulan_laporan['nama_desa'] == 'h') { echo "selected"; }?> value="h">Haruai</option>
                  <option <?php if($row_pengumpulan_laporan['nama_desa'] == 'n') { echo "selected"; }?> value="n">Nawin</option>
                  <option <?php if($row_pengumpulan_laporan['nama_desa'] == 'sm') { echo "selected"; }?> value="sm">Sungai Miai</option>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="id_pengumpulan" value="<?php echo $row_pengumpulan_laporan['id_pengumpulan']; ?>">
                 <input type="hidden" name="MM_update" value="pengumpulan_laporan">
