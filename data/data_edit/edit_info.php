            ...
            <div class="form-panel">
              <form name="info" method="post" action="<?php $editFormAction ?>" class="form-horizontal style-form" enctype="multipart/form-data" id="info">
                ...
                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" name="nama_info" placeholder="Nama Info" id="c-name" class="form-control" required maxlength="225" value="<?php echo $row_info['nama_info']; ?>">
                            </div>
                          </div>
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="id_info" value="<?php echo $row_info['id_info']; ?>">
                
                 <input type="hidden" name="MM_update" value="info">
