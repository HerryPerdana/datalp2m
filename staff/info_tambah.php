...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "info")) {
  $insertSQL = sprintf("INSERT INTO tb_info (nama_info, lampiran) VALUES (%s, %s)",
 ...
 echo " <script type='text/javascript'>alert('Data Info KKN Berhasil Di Tambah'); location.href=\"../admin/info.php\";</script>";
	  
  }else if($_SESSION['jabatan'] == "Staff"){

 echo " <script type='text/javascript'>alert('Data Info KKN Berhasil Di Tambah'); location.href=\"../staff/info.php\";</script>";
...
<body>
  ...
  <?php include('header.php'); ?>
    ...
    <section id="main-content">
      ...
      <p>&nbsp;</p>
        <h3><i class="fa fa-angle-right"></i> Tambah Info KKN</h3>
        <div class="row mt">
          <!--  Form -->
          
          <?php include ('../data/data_input/input_info.php'); ?>
