...
if(isset($_GET['cari'])){
		$cari = $_GET['cari'];
		$query_dokumen = "SELECT * FROM tb_dokumen WHERE unit='pm' AND tipe='sr' AND nama_dokumen like '%".$cari."%' ORDER BY id_dokumen DESC";				
	}else{
$query_dokumen = "SELECT * FROM tb_dokumen WHERE unit='pm' AND tipe='sr' ORDER BY id_dokumen DESC";
