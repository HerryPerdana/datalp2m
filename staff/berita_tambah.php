...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "tambah")) {
  ...
  $insertSQL = sprintf("INSERT INTO tb_berita (judul, isi, tanggal, gambar) VALUES (%s, %s, %s, %s)",
 ...
 echo " <script type='text/javascript'>alert('Berita Berhasil Di Tambah'); location.href=\"../admin/berita.php\";</script>";
	  
  }else if($_SESSION['jabatan'] == "Staff"){

 echo " <script type='text/javascript'>alert('Berita Berhasil Di Tambah'); location.href=\"../staff/berita.php\";</script>";
    ...
    <section id="main-content">
      ...
      <p>&nbsp;</p>
        ...
        <div class="row mt">
          ...
          <?php include ('../data/data_input/input_berita.php'); ?>
