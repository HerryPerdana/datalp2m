...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "pengumpulan_laporan")) {
  $updateSQL = sprintf("UPDATE tb_pengumpulan_laporan SET email=%s, nama_desa=%s, kecamatan=%s, kabupaten=%s, laporan_program_kerja=%s, laporan_kkn=%s WHERE id_pengumpulan=%s",
                       ...
                       GetSQLValueString($_POST['id_pengumpulan'], "text"));
 ...
 echo " <script type='text/javascript'>alert('Data Laporan KKN Berhasil Di Rubah'); location.href=\"../admin/laporan_kkn.php\";</script>";
	  
  }else if($_SESSION['jabatan'] == "Staff"){

 echo " <script type='text/javascript'>alert('Data Laporan KKN Berhasil Di Rubah'); location.href=\"../staff/laporan_kkn.php\";</script>";
	  
  }
}


$colname_pengumpulan_laporan = "-1";
if (isset($_GET['id_pengumpulan'])) {
  $colname_pengumpulan_laporan = $_GET['id_pengumpulan'];
}
$query_pengumpulan_laporan = sprintf("SELECT * FROM tb_pengumpulan_laporan WHERE id_pengumpulan = %s", GetSQLValueString($colname_pengumpulan_laporan, "int"));
...
<head>
  ...
  <meta name="keyword" content="Dashboard, Bootstrap, pengumpulan_laporan, Template, Theme, Responsive, Fluid, Retina">
  <title>ADMIN</title>
  ...
  <!-- =======================================================
    ...
    Template URL: https://templatemag.com/dashio-bootstrap-pengumpulan_laporan-template/
...
<body>
  ...
  <?php include('header.php'); ?>
    ...
    <section id="main-content">
      ...
      <p>&nbsp;</p>
        <h3><i class="fa fa-angle-right"></i> Edit Laporan KKN</h3>
        <div class="row mt">
          <!--  Form -->
          
          <?php include ('../data/data_edit/edit_pengumpulan_laporan.php'); ?>
