...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "admin")) {
  $updateSQL = sprintf("UPDATE tb_admin SET  nip=%s, nama_admin=%s, alamat_admin=%s, cp=%s,jabatan=%s,username=%s, password=%s, foto=%s WHERE id_admin=%s",
 ...
 echo " <script type='text/javascript'>alert('Data Berhasil Di Edit'); location.href=\"../admin/admin.php\";</script>";
	  
  }else if($_SESSION['jabatan'] == "Staff"){

 echo " <script type='text/javascript'>alert('Data Berhasil Di Edit'); location.href=\"../staff/admin.php\";</script>";
...
$query_admin = sprintf("SELECT * FROM tb_admin WHERE id_admin = %s", GetSQLValueString($colname_admin, "int"));
    ...
    <section id="main-content">
      ...
      <p>&nbsp;</p>
        ...
        <div class="row mt">
          ...
          <?php include ('../data/data_edit/edit_admin.php'); ?>
