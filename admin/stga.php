...
if(isset($_GET['cari'])){
		$cari = $_GET['cari'];
		$query_dokumen = "SELECT * FROM tb_dokumen WHERE unit='ga' AND tipe='st' AND nama_dokumen like '%".$cari."%' ORDER BY id_dokumen DESC";				
	}else{
$query_dokumen = "SELECT * FROM tb_dokumen WHERE unit='ga' AND tipe='st' ORDER BY id_dokumen DESC";
