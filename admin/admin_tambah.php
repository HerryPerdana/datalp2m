...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "admin")) {
  $insertSQL = sprintf("INSERT INTO tb_admin (nip, nama_admin, alamat_admin, cp, jabatan, username, password, foto) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 echo " <script type='text/javascript'>alert('Data Admin Berhasil Di Tambah'); location.href=\"../admin/admin.php\";</script>";
	  
  }else if($_SESSION['jabatan'] == "Staff"){

 echo " <script type='text/javascript'>alert('Data Admin Berhasil Di Tambah'); location.href=\"../staff/admin.php\";</script>";
    ...
    <section id="main-content">
      ...
      <p>&nbsp;</p>
        ...
        <div class="row mt">
          ...
          <?php include ('../data/data_input/input_admin.php'); ?>
