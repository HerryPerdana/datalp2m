...
if(isset($_GET['cari'])){
		$cari = $_GET['cari'];
		$query_dokumen = "SELECT * FROM tb_dokumen WHERE unit='pp' AND tipe='hp' AND nama_dokumen like '%".$cari."%' ORDER BY id_dokumen DESC";				
	}else{
$query_dokumen = "SELECT * FROM tb_dokumen WHERE unit='pp' AND tipe='hp' ORDER BY id_dokumen DESC";
